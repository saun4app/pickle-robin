...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../../../../../../../../.nvm/versions/node/v16.14.0/lib/node_modules/parcel-bundler/node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
},{}],"../../../../../../../../../.nvm/versions/node/v16.14.0/lib/node_modules/parcel-bundler/node_modules/ieee754/index.js":[function(require,module,exports) {
...
},{}],"../../../../../../../../../.nvm/versions/node/v16.14.0/lib/node_modules/parcel-bundler/node_modules/isarray/index.js":[function(require,module,exports) {
...
},{}],"../../../../../../../../../.nvm/versions/node/v16.14.0/lib/node_modules/parcel-bundler/node_modules/buffer/index.js":[function(require,module,exports) {
...
},{"base64-js":"../../../../../../../../../.nvm/versions/node/v16.14.0/lib/node_modules/parcel-bundler/node_modules/base64-js/index.js","ieee754":"../../../../../../../../../.nvm/versions/node/v16.14.0/lib/node_modules/parcel-bundler/node_modules/ieee754/index.js","isarray":"../../../../../../../../../.nvm/versions/node/v16.14.0/lib/node_modules/parcel-bundler/node_modules/isarray/index.js","buffer":"../../../../../../../../../.nvm/versions/node/v16.14.0/lib/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"node_modules/lodash/lodash.js":[function(require,module,exports) {
var global = arguments[3];
...
},{"buffer":"../../../../../../../../../.nvm/versions/node/v16.14.0/lib/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"../../../node_modules/fastest-validator/dist/index.min.js":[function(require,module,exports) {
var global = arguments[3];
var define;
...
},{}],"../../../node_modules/robin-js/dist/index.umd.js":[function(require,module,exports) {
var define;
var global = arguments[3];
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
  typeof define === 'function' && define.amd ? define(factory) :
  (global.pairsCalc = factory());
  ...
  var index = (participants, opts = { randomStart: false, rounds: 0 }) => {
...
},{}],"src/share-code.js":[function(require,module,exports) {
...
var pairsCalc = require("robin-js");
// const path = require("path");

//// ParamUtil
var ParamUtil = /*#__PURE__*/function () {
  function ParamUtil() {
    _classCallCheck(this, ParamUtil);
  }
  _createClass(ParamUtil, null, [{
    key: "is_valid",
    value:
    // ParamUtil.is_valid(schema_key, data_obj)
    function is_valid(schema_key, data_obj) {
      var schema_obj = ParamUtil[schema_key];
      var validator_obj = new FastestValidator();
      var check_obj = validator_obj.compile(schema_obj);
      return check_obj(data_obj);
    }
  }]);
  return ParamUtil;
}(); //// Util
_defineProperty(ParamUtil, "gen_match_item_col", {
  player_item_list: {
    type: "array",
    items: "object"
  }
});
_defineProperty(ParamUtil, "create_pool_match_group", {
  player_id_list: {
    type: "array"
  }
});
var ClassHelper = /*#__PURE__*/function () {
  ...
  _createClass(ClassHelper, null, [{
    key: "init_attr",
    value:
    // ClassHelper.init_attr(this, param_obj)
    function init_attr(self) {
      var param_obj = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
...
var ItemBase = /*#__PURE__*/function () {
  ...
  _createClass(ItemBase, [{
    ...
    key: "to_js_obj",
    value: function to_js_obj() {
      return Object.assign({}, this.attr);
    }
  }]);
  return ItemBase;
}();
var ItemListBase = /*#__PURE__*/function () {
  function ItemListBase() {
    var param_obj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    _classCallCheck(this, ItemListBase);
    ClassHelper.init_attr(this, param_obj);
    // this.attr.main_item_list = [];
  }
  _createClass(ItemListBase, [{
    key: "get_attr",
    value: function get_attr(key) {
      return this.attr[key];
    }
    ...
    value: function to_js_obj() {
      var _item_list = [];
      var _iterator = _createForOfIteratorHelper(this.attr.main_item_list),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var item = _step.value;
          _item_list.push(item.to_js_obj());
        }
      } catch (err) {
        _iterator.e(err);
      } finally {
...
},{"lodash":"node_modules/lodash/lodash.js","fastest-validator":"../../../node_modules/fastest-validator/dist/index.min.js","robin-js":"../../../node_modules/robin-js/dist/index.umd.js"}],"src/dupr-player-list.js":[function(require,module,exports) {
...
module.exports = {
  player_item_list: player_item_list
};
},{}],"src/robin-player.js":[function(require,module,exports) {
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var ClassHelper = require('./share-code.js').ClassHelper;
var ItemBase = require('./share-code.js').ItemBase;
var ItemListBase = require('./share-code.js').ItemListBase;

//// Player
var PlayerItemHelper = /*#__PURE__*/function () {
  function PlayerItemHelper() {
    _classCallCheck(this, PlayerItemHelper);
  }
  _createClass(PlayerItemHelper, null, [{
    key: "init",
    value:
    // PlayerItemHelper.init(this, param_obj)
    function init(self, param_obj) {
      ClassHelper.init_attr(self, param_obj);
    }
  }]);
  return PlayerItemHelper;
}();
var PlayerItemColHelper = /*#__PURE__*/function () {
  function PlayerItemColHelper() {
    _classCallCheck(this, PlayerItemColHelper);
  }
  _createClass(PlayerItemColHelper, null, [{
    key: "init",
    value:
    // PlayerItemColHelper.init(this, param_obj)
    function init(self, param_obj) {
      ClassHelper.init_attr(self, param_obj);
      self.attr.main_item_list = [];
      PlayerItemColHelper.retrive_player_list(self, param_obj);
    }

    // PlayerItemListHelper.add_item(self, player_obj = {})
  }, {
    key: "add_item",
    value: function add_item(self, player_obj) {
      var player_item = new PlayerItem(player_obj);
      self.attr.main_item_list.push(player_item);
    }

    // PlayerItemColHelper.filter_by_id_list(this, id_list)
  }, {
    key: "filter_by_id_list",
    value: function filter_by_id_list(self, id_list) {
      var item_list = [];
      ...
      try {
        var _loop = function _loop() {
          var _id = _step.value;
          var item = _.find(self.attr.main_item_list, function (item) {
            return _id == item.get_attr("id");
          });
          if (item) {
            item_list.push(item);
          }
    ...
    key: "retrive_player_list",
    value: function retrive_player_list(self) {
      var param_obj = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var player_list = PlayerItemColHelper._read_player_list_json(param_obj);
      var _iterator2 = _createForOfIteratorHelper(player_list),
        _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var player_obj = _step2.value;
          PlayerItemColHelper.add_item(self, player_obj);
        }
      } catch (err) {
        _iterator2.e(err);
      } finally {
    ...
    // PlayerItemColHelper._read_player_list_json(param_obj = {})
  }, {
    key: "_read_player_list_json",
    value: function _read_player_list_json() {
      var param_obj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var player_item_list = require('./dupr-player-list.js').player_item_list;
      console.log(player_item_list.length);
      return player_item_list;
    }
  }]);
  return PlayerItemColHelper;
}();
var PlayerItem = /*#__PURE__*/function (_ItemBase) {
  _inherits(PlayerItem, _ItemBase);
  var _super = _createSuper(PlayerItem);
  function PlayerItem() {
    var _this;
    var param_obj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    _classCallCheck(this, PlayerItem);
    _this = _super.call(this, param_obj);
    PlayerItemHelper.init(_assertThisInitialized(_this), param_obj);
    return _this;
  }
  return _createClass(PlayerItem);
}(ItemBase);
var PlayerItemCol = /*#__PURE__*/function (_ItemListBase) {
  _inherits(PlayerItemCol, _ItemListBase);
  var _super2 = _createSuper(PlayerItemCol);
  function PlayerItemCol() {
    var _this2;
    var param_obj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    _classCallCheck(this, PlayerItemCol);
    _this2 = _super2.call(this, param_obj);
    PlayerItemColHelper.init(_assertThisInitialized(_this2), param_obj);
    return _this2;
  }
  _createClass(PlayerItemCol, [{
    key: "add_player",
    value: function add_player(player_item) {
      this.attr.main_item_list.push(player_item);
    }
  }, {
    key: "filter_by_id_list",
    value: function filter_by_id_list(id_list) {
      return PlayerItemColHelper.filter_by_id_list(this, id_list);
    }
  }]);
  return PlayerItemCol;
}(ItemListBase);
module.exports = {
  PlayerItemCol: PlayerItemCol
};
},{"./share-code.js":"src/share-code.js","./dupr-player-list.js":"src/dupr-player-list.js"}],"../../../../../../../../../.nvm/versions/node/v16.14.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../../../../../../.nvm/versions/node/v16.14.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/robin-player.js"], null)
//# sourceMappingURL=/robin-player.b8a92aba.js.map